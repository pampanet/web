...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1615: () => globalThis.window.navigator.userAgent,
      _1616: x0 => x0.createRange(),
      _1617: (x0,x1) => x0.selectNode(x1),
      _1618: x0 => x0.getSelection(),
      _1619: x0 => x0.removeAllRanges(),
      _1620: (x0,x1) => x0.addRange(x1),
      ...
      _1644: (x0,x1) => x0.querySelector(x1),
      _1671: () => new Array(),
      ...
      _1699: (o, t) => typeof o === t,
      _1700: (o, c) => o instanceof c,
      _1701: (x0,x1,x2,x3,x4,x5) => x0.call(x1,x2,x3,x4,x5),
      ...
      _1736: x0 => new FinalizationRegistry(x0),
      _1737: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1739: (x0,x1) => x0.unregister(x1),
      _1740: Date.now,
      ...
      _1757: () => globalThis.FinalizationRegistry,
      _1764: s => JSON.stringify(s),
      _1765: s => printToConsole(s),
      _1766: a => a.join(''),
      ...
      _1782: (a, i) => a.push(i),
      _1783: (a, i) => a.splice(i, 1)[0],
      _1785: (a, l) => a.length = l,
      _1786: a => a.pop(),
      _1787: (a, i) => a.splice(i, 1),
      _1789: (a, s) => a.join(s),
      _1790: (a, s, e) => a.slice(s, e),
      _1791: (a, s, e) => a.splice(s, e),
      _1792: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1793: a => a.length,
      _1795: (a, i) => a[i],
      _1796: (a, i, v) => a[i] = v,
      _1798: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1799: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1800: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1801: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1802: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1803: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1804: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1805: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1807: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1808: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1809: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1810: (t, s) => t.set(s),
      _1811: l => new DataView(new ArrayBuffer(l)),
      _1812: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1813: o => o.byteLength,
      _1814: o => o.buffer,
      ...
      _1851: (x0,x1) => x0.postMessage(x1),
      _1853: x0 => new Worker(x0),
      _1856: x0 => ({create: x0}),
      _1857: (x0,x1,x2) => x0.getFileHandle(x1,x2),
      _1865: (x0,x1,x2) => x0.open(x1,x2),
      _1879: (x0,x1) => new SharedWorker(x0,x1),
      _1880: x0 => x0.start(),
      _1881: (x0,x1,x2) => x0.postMessage(x1,x2),
      _1882: (x0,x1,x2) => x0.postMessage(x1,x2),
      _1883: x0 => x0.close(),
      _1884: x0 => x0.terminate(),
      _1885: () => new MessageChannel(),
      _1886: () => new MessageChannel(),
      _1887: x0 => x0.start(),
      _1888: x0 => x0.close(),
      _1891: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1891(f,arguments.length,x0) }),
      _1892: x0 => x0.close(),
      _1893: x0 => new BroadcastChannel(x0),
      _1894: x0 => globalThis.Array.isArray(x0),
      _1895: (x0,x1) => x0.postMessage(x1),
      _1898: (x0,x1) => ({kind: x0,table: x1}),
      _1899: x0 => x0.kind,
      _1900: x0 => x0.table,
      _1901: (x0,x1) => ({i: x0,p: x1}),
      _1902: (x0,x1) => ({c: x0,r: x1}),
      _1903: x0 => x0.i,
      _1904: x0 => x0.p,
      _1905: x0 => x0.c,
      _1906: x0 => x0.r,
      _1908: (o, t) => o instanceof t,
      ...
      _1912: o => Object.keys(o),
      _1913: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1914: (handle) => clearTimeout(handle),
      _1915: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1916: (handle) => clearInterval(handle),
      _1917: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1918: () => Date.now(),
      _1919: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1920: (x0,x1,x2) => x0.fetch(x1,x2),
      _1921: (x0,x1) => x0.get(x1),
      _1922: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1922(f,arguments.length,x0,x1,x2) }),
      _1923: (x0,x1) => x0.forEach(x1),
      _1924: x0 => x0.abort(),
      _1925: () => new AbortController(),
      _1926: x0 => x0.getReader(),
      _1927: x0 => x0.read(),
      _1928: x0 => x0.cancel(),
      _1933: x0 => new URL(x0),
      _1934: (x0,x1) => new URL(x0,x1),
      _1935: (x0,x1) => globalThis.fetch(x0,x1),
      _1936: (x0,x1,x2,x3) => x0.call(x1,x2,x3),
      _1937: x0 => ({initial: x0}),
      _1938: x0 => new WebAssembly.Memory(x0),
      _1939: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1939(f,arguments.length,x0) }),
      _1940: f => finalizeWrapper(f, function(x0,x1,x2,x3,x4) { return dartInstance.exports._1940(f,arguments.length,x0,x1,x2,x3,x4) }),
      _1941: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1941(f,arguments.length,x0,x1,x2) }),
      _1942: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1942(f,arguments.length,x0,x1,x2,x3) }),
      _1943: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1943(f,arguments.length,x0,x1,x2,x3) }),
      _1944: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1944(f,arguments.length,x0,x1,x2) }),
      ...
      _1949: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1949(f,arguments.length,x0,x1,x2,x3) }),
      _1950: f => finalizeWrapper(f, function(x0,x1,x2,x3) { return dartInstance.exports._1950(f,arguments.length,x0,x1,x2,x3) }),
      ...
      _1958: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1958(f,arguments.length,x0,x1,x2) }),
      _1959: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1959(f,arguments.length,x0,x1,x2) }),
      ...
      _1963: f => finalizeWrapper(f, function(x0,x1,x2,x3,x4) { return dartInstance.exports._1963(f,arguments.length,x0,x1,x2,x3,x4) }),
      _1964: f => finalizeWrapper(f, function(x0,x1,x2,x3,x4) { return dartInstance.exports._1964(f,arguments.length,x0,x1,x2,x3,x4) }),
      ...
      _1967: (x0,x1,x2,x3,x4,x5,x6) => x0.call(x1,x2,x3,x4,x5,x6),
      _1968: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.call(x1,x2,x3,x4,x5,x6,x7),
      _1969: (x0,x1,x2,x3,x4) => x0.call(x1,x2,x3,x4),
      _1970: x0 => x0.continue(),
      _1971: () => globalThis.indexedDB,
      _1973: x0 => x0.arrayBuffer(),
      _1975: x0 => new SharedArrayBuffer(x0),
      _1976: x0 => ({at: x0}),
      _1984: x0 => x0.synchronizationBuffer,
      _1985: x0 => x0.communicationBuffer,
      _1986: (x0,x1,x2,x3) => ({clientVersion: x0,root: x1,synchronizationBuffer: x2,communicationBuffer: x3}),
      _1987: x0 => new SharedArrayBuffer(x0),
      _1988: (x0,x1) => globalThis.IDBKeyRange.bound(x0,x1),
      _1989: x0 => ({autoIncrement: x0}),
      _1990: (x0,x1,x2) => x0.createObjectStore(x1,x2),
      _1991: x0 => ({unique: x0}),
      _1992: (x0,x1,x2,x3) => x0.createIndex(x1,x2,x3),
      _1993: (x0,x1) => x0.createObjectStore(x1),
      _1994: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1994(f,arguments.length,x0) }),
      _1995: (x0,x1,x2) => x0.transaction(x1,x2),
      _1996: (x0,x1) => x0.objectStore(x1),
      _1997: x0 => new Blob(x0),
      _1998: (x0,x1,x2) => x0.add(x1,x2),
      _1999: (x0,x1) => x0.get(x1),
      _2000: x0 => x0.abort(),
      _2001: x0 => x0.close(),
      _2004: (x0,x1) => x0.objectStore(x1),
      _2005: (x0,x1) => x0.index(x1),
      _2006: x0 => x0.openKeyCursor(),
      _2007: (x0,x1) => x0.objectStore(x1),
      _2008: (x0,x1) => x0.index(x1),
      _2009: (x0,x1) => x0.getKey(x1),
      _2010: (x0,x1) => x0.objectStore(x1),
      _2011: (x0,x1) => ({name: x0,length: x1}),
      _2012: (x0,x1) => x0.put(x1),
      _2013: (x0,x1) => x0.objectStore(x1),
      _2014: (x0,x1) => x0.get(x1),
      _2015: (x0,x1) => x0.objectStore(x1),
      _2016: (x0,x1) => x0.openCursor(x1),
      _2018: (x0,x1) => x0.objectStore(x1),
      _2019: x0 => globalThis.IDBKeyRange.only(x0),
      _2020: (x0,x1,x2) => x0.put(x1,x2),
      _2021: (x0,x1) => x0.update(x1),
      _2022: (x0,x1) => x0.objectStore(x1),
      _2023: (x0,x1) => x0.update(x1),
      _2024: (x0,x1) => x0.objectStore(x1),
      _2025: (x0,x1) => x0.objectStore(x1),
      _2026: (x0,x1) => x0.delete(x1),
      _2027: (x0,x1) => x0.update(x1),
      _2028: (x0,x1) => x0.objectStore(x1),
      _2029: (x0,x1) => x0.delete(x1),
      _2030: (x0,x1) => x0.objectStore(x1),
      _2031: (x0,x1) => x0.delete(x1),
      _2034: x0 => x0.name,
      _2035: x0 => x0.length,
      _2037: x0 => x0.createSyncAccessHandle(),
      _2038: (x0,x1) => x0.truncate(x1),
      _2039: (x0,x1) => x0.truncate(x1),
      _2040: x0 => x0.close(),
      _2041: x0 => x0.close(),
      _2042: x0 => x0.flush(),
      _2043: x0 => x0.getSize(),
      _2044: x0 => x0.flush(),
      _2045: (x0,x1) => x0.truncate(x1),
      _2058: x0 => globalThis.BigInt(x0),
      _2059: x0 => globalThis.Number(x0),
      _2062: x0 => globalThis.Object.keys(x0),
      _2067: (x0,x1) => globalThis.WebAssembly.instantiateStreaming(x0,x1),
      _2068: x0 => x0.call(),
      _2069: x0 => x0.exports,
      _2070: x0 => x0.instance,
      _2074: x0 => x0.buffer,
      _2075: () => globalThis.WebAssembly.Global,
      _2078: () => globalThis.navigator,
      _2079: x0 => x0.getDirectory(),
      _2080: (x0,x1) => x0.read(x1),
      _2081: (x0,x1,x2) => x0.read(x1,x2),
      _2082: (x0,x1) => x0.write(x1),
      _2083: (x0,x1,x2) => x0.write(x1,x2),
      _2084: x0 => ({create: x0}),
      _2085: (x0,x1,x2) => x0.getDirectoryHandle(x1,x2),
      ...
      _2120: (x0,x1) => x0.test(x1),
      _2121: (x0,x1) => x0.exec(x1),
      _2122: (x0,x1) => x0.exec(x1),
      _2123: x0 => x0.pop(),
      _2125: o => o === undefined,
      _2144: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2146: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2147: o => o instanceof RegExp,
      _2148: (l, r) => l === r,
      _2149: o => o,
      _2150: o => o,
      _2151: o => o,
      ...
      _2153: o => o.length,
      _2156: (o, i) => o[i],
      _2157: f => f.dartFunction,
      _2158: l => arrayFromDartList(Int8Array, l),
      _2159: l => arrayFromDartList(Uint8Array, l),
      _2160: l => arrayFromDartList(Uint8ClampedArray, l),
      _2161: l => arrayFromDartList(Int16Array, l),
      _2162: l => arrayFromDartList(Uint16Array, l),
      _2163: l => arrayFromDartList(Int32Array, l),
      _2164: l => arrayFromDartList(Uint32Array, l),
      _2165: l => arrayFromDartList(Float32Array, l),
      _2166: l => arrayFromDartList(Float64Array, l),
      _2167: x0 => new ArrayBuffer(x0),
      _2168: (data, length) => {
      ...
      _2176: (o, p) => o[p],
      _2177: (o, p, v) => o[p] = v,
      _2178: (o, m, a) => o[m].apply(o, a),
      _2180: o => String(o),
      _2181: (p, s, f) => p.then(s, f),
      _2182: o => {
      ...
      _2192: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _2196: x0 => x0.index,
      _2197: x0 => x0.groups,
      _2199: (x0,x1) => x0.exec(x1),
      _2201: x0 => x0.flags,
      _2202: x0 => x0.multiline,
      _2203: x0 => x0.ignoreCase,
      _2204: x0 => x0.unicode,
      _2205: x0 => x0.dotAll,
      _2206: (x0,x1) => x0.lastIndex = x1,
      _2207: (o, p) => p in o,
      _2208: (o, p) => o[p],
      _2209: (o, p, v) => o[p] = v,
      _2211: (x0,x1,x2) => globalThis.Atomics.wait(x0,x1,x2),
      _2213: (x0,x1,x2) => globalThis.Atomics.notify(x0,x1,x2),
      _2214: (x0,x1,x2) => globalThis.Atomics.store(x0,x1,x2),
      _2215: (x0,x1) => globalThis.Atomics.load(x0,x1),
      _2216: () => globalThis.Int32Array,
      _2218: () => globalThis.Uint8Array,
      _2220: () => globalThis.DataView,
      _2223: x0 => x0.byteLength,
      _2228: x0 => x0.random(),
      _2229: x0 => x0.random(),
      _2230: (x0,x1) => x0.getRandomValues(x1),
      _2231: () => globalThis.crypto,
      _2233: () => globalThis.Math,
      _2235: Function.prototype.call.bind(Number.prototype.toString),
      _2236: (d, digits) => d.toFixed(digits),
      _2240: () => globalThis.document,
      _2241: () => globalThis.window,
      _2246: (x0,x1) => x0.height = x1,
      _2248: (x0,x1) => x0.width = x1,
      _2252: x0 => x0.head,
      _2255: x0 => x0.classList,
      _2260: (x0,x1) => x0.innerText = x1,
      _2261: x0 => x0.style,
      _2263: x0 => x0.sheet,
      _2264: x0 => x0.src,
      _2265: (x0,x1) => x0.src = x1,
      _2266: x0 => x0.naturalWidth,
      _2267: x0 => x0.naturalHeight,
      _2275: x0 => x0.offsetX,
      _2276: x0 => x0.offsetY,
      _2277: x0 => x0.button,
      _2292: x0 => x0.status,
      _2293: (x0,x1) => x0.responseType = x1,
      _2295: x0 => x0.response,
      _4166: () => globalThis.window,
      _4230: x0 => x0.navigator,
      _4621: x0 => x0.userAgent,
      _4634: x0 => x0.storage,
      _4672: x0 => x0.data,
      _4703: x0 => x0.port1,
      _4704: x0 => x0.port2,
      _4710: (x0,x1) => x0.onmessage = x1,
      _4796: x0 => x0.port,
      _6864: x0 => x0.signal,
      _6943: () => globalThis.document,
      _7387: (x0,x1) => x0.id = x1,
      _7414: x0 => x0.children,
      _8768: x0 => x0.value,
      _8770: x0 => x0.done,
      _9481: x0 => x0.url,
      _9483: x0 => x0.status,
      _9485: x0 => x0.statusText,
      _9486: x0 => x0.headers,
      _9487: x0 => x0.body,
      _10960: x0 => x0.result,
      _10961: x0 => x0.error,
      _10972: (x0,x1) => x0.onupgradeneeded = x1,
      _10974: x0 => x0.oldVersion,
      _11064: x0 => x0.key,
      _11065: x0 => x0.primaryKey,
      _11067: x0 => x0.value,
      _13904: () => globalThis.window.flutterCanvasKit,
      _13905: () => globalThis.window._flutter_skwasmInstance,
